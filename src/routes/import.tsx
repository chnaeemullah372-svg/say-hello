...
import { Download, Upload, Users, Truck, Package, FileSpreadsheet, CheckCircle2, AlertCircle } from "lucide-react";
      ...
      for (const row of rows) {
        try {
          if (mode === "clients" || mode === "suppliers") {
            ...
            const openingAmount = Number(row.OpeningBalance ?? row.openingBalance ?? 0);
            await addCustomer({
              partyType: mode === "suppliers" ? "supplier" : "client", name: String(name),
